...
-- this module exists solely for getting myself ready & comfortable
-- to write many-many tests using the awesome hedgehog package
-- here I'll work through the examples from the "hedgehog-example" project
-- first, I'm going to re-type everything and experiment in the REPL for a while
